...
nginx['enable'] = {{ gitlab__nginx_enable | bool | lower  }}
...
nginx['listen_addresses'] = [{{ '\'' + gitlab__nginx_listen_addresses | join('\', \'') + '\'' }}]
...
nginx['listen_port'] = {{ gitlab__nginx_listen_port }}
...
################################################################################
letsencrypt['enable'] = {{ gitlab__letsencrypt_enable | bool | lower }}
